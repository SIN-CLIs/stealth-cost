# successful.md — Erfolgreiche Abläufe (stealth-cost)
...
- **Reproduzierbar**: Ja — `python3 /Users/jeremy/dev/stealth-runner/scripts/generate_missing_docs.py --repo stealth-cost`
