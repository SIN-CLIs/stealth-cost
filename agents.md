# AGENTS.md — Agenten-Anleitung (stealth-cost)
...
4. Doc-Health checken: `python3 /Users/jeremy/dev/stealth-runner/scripts/check_doc_health.py --repo stealth-cost`

## Repo-Info

- **Layer**: 💰 Cost
- **Beschreibung**: SOTAOptimizer Orchestrator — Unified Cost Pipeline
